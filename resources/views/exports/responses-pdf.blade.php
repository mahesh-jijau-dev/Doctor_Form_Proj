...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .data th { padding: 8px 7px; color: #fff; background: #0f766e; text-align: left; font-size: 8px; }
        .data td { padding: 7px; border: 1px solid #e2e8f0; vertical-align: top; word-wrap: break-word; }
