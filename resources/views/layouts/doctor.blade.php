        ...
        <aside class="bg-sidebar flex-shrink-0 flex flex-col transition-all duration-300"
            ...
            <nav class="flex-1 px-3 py-4 overflow-y-auto">
                ...
                <a href="{{ route('doctor.dashboard') }}"
                   class="sidebar-item {{ request()->routeIs('doctor.dashboard') ? 'active' : '' }}">
                    <i class="fas fa-tachometer-alt icon"></i>
                    <span>Dashboard</span>
                </a>

                <p class="text-xs font-semibold text-white/30 uppercase tracking-widest px-3 mt-4 mb-2">Forms</p>
                <a href="{{ route('doctor.forms.index') }}"
                   class="sidebar-item {{ request()->routeIs('doctor.forms*') ? 'active' : '' }}">
                    <i class="fas fa-file-alt icon"></i>
                    <span>My Forms</span>
                </a>

                <p class="text-xs font-semibold text-white/30 uppercase tracking-widest px-3 mt-4 mb-2">Data</p>
                <a href="{{ route('doctor.responses.index') }}"
                   class="sidebar-item {{ request()->routeIs('doctor.responses*') ? 'active' : '' }}">
            ...
            <div class="px-3 py-3 border-t border-white/10">
                <div class="flex items-center gap-3 px-3 py-2 rounded-lg">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <p class="text-white/40 text-xs">Doctor</p>
                    </div>
                </div>
